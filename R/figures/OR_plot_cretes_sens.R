...
Mod_laus_or <- glm(Duree_2me_periode_z  ~  sex + parity + Position_normal +  Bassin_Cretes+birthweight100 +   head_ConjExt,
                   data = data_laus)


Mod_basel_or <- glm(Duree_2me_periode_z  ~   sex + parity + Position_normal +  Bassin_Cretes+birthweight100+  head_ConjExt,
                    data = data_basel)
