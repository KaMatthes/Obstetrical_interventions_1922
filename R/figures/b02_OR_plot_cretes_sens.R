...
Mod_laus_or <- glm(explusion_z  ~  sex + parity + position_normal +  bassin_cretes+birthweight100 +   head_ConjExt,
                   data = data_laus)


Mod_basel_or <- glm(explusion_z  ~   sex + parity + position_normal +  bassin_cretes+birthweight100+  head_ConjExt,
                    data = data_basel)
